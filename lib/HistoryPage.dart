...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  uploaddata(String id, String url) async {
    ...
    var response = await http.post(Uri.parse("http://151.106.17.246:8080/byco/api/orderimages.php?accesskey=12345&orderid=" + id + "&imgurl=" + url,));
  ...
  Future<void> _fetchData() async {
    ...
    String API_URL = "http://151.106.17.246:8080/byco/api/testing.php?cus_id=" + userid.toString() + "&accesskey=12345";
      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
            ...
            Container(
              child: Text("History", style: TextStyle(color: Constants.primaryorrange,),),
            ),
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: ListTile(
                      ...
                      //   fit: BoxFit.cover,
                      // ),
                      title: Container(width: double.infinity, alignment: Alignment.center, child: Text(_loadedPhotos[index]['date'], style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold))),
                      subtitle:
                      Column(
                        children: [
                          SizedBox(height: 20,),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('Delivery Type: ', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                              Text('${_loadedPhotos[index]["delivery_based"]}', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
                            ],
                          ),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text('${_loadedPhotos[index]["quantity"]}', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                            ],
                          ),
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('Depot: ', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                              Text('${_loadedPhotos[index]["depot"]}', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                            ],
                          ),
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('Product Type: ', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                              Text('${_loadedPhotos[index]["product_type"]}', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                            ],
                          ),
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('Order ID: ', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                              Text('${_loadedPhotos[index]["id"]}', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                            ],
                          ),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              if('${_loadedPhotos[index]["status"]}' == "0") ...{
                                ...
                                Text('${_loadedPhotos[index]["status"]}',  style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                              },
                              // Text('${_loadedPhotos[index]["vehicle"]}', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                            ],
                          ),
                            ...
                            children: [
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                        // child: Text('Upload photos', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.white)),
                                  ...
                                  InkWell(
                                    onTap: () async{
                                      ...
                                      uploaddata(_loadedPhotos[index]["id"], newUrl.toString());
                                      toastMessage("Image saved");
                              ...
                              GestureDetector(
                                onTap: (){
                                  ...
                                  updatestatus(_loadedPhotos[index]["id"]);
                                  Navigator.of(context).pushAndRemoveUntil(
                                      MaterialPageRoute(
                                          builder: (BuildContext context) => HistoryScreen()),
                                          (Route<dynamic>route) => false);
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text('Cancel', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.white)),
  ...
  updatestatus(String ooid) async{
    ...
    var response = await http.put(Uri.parse("http://151.106.17.246:8080/byco/api/orderstatus.php?accesskey=12345&orderid=" + ooid,));
