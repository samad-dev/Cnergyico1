...
class Lube extends StatefulWidget {
  const Lube({Key? key}) : super(key: key);

  @override
  _LubeScreenState createState() => _LubeScreenState();
}

class _LubeScreenState extends State<Lube> {
  ...
  String dropdownValue = "Signage";
  String dropdownValue1 = "Monolith";
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              // value: dropdownValue,
                              items: <String>["Signage", "Lightning", "Fuel Dispenser","DG Set","Air Compressor","Pump Controller","Electrical","Civil Works","C Store","Miscellaneous"]
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              // value: dropdownValue,
                              items: <String>["Canopy Fascia","Monolith","In/Out Sign","Flat Sign","Directory Sign","Spreaders",]
                                  .map<DropdownMenuItem<String>>(
                                      (String value) {
                                    return DropdownMenuItem<String>(
                                      value: value,
